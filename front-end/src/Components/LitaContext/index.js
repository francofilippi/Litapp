...
const LitaContext = React.createContext();

export default function LitaProvider(props) { // Puente o fx entre TodoContext.Provider y TodoContext.Consumer
  ...
  return (
    <LitaContext.Provider value={{ // En un objeto van todas las propiedades, metodos y atributos que quiero compartir con mi provider
      value,
      setValue,
      inputValue,
      setInputValue,
